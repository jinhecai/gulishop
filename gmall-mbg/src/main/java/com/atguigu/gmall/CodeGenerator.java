...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\project_java\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("Lfy");
        ...
        gc.setBaseResultMap(true);//生成xml的baseMapper
        ...
        dsc.setUrl("jdbc:mysql://192.168.81.100:3316/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
